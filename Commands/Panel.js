...
module.exports.execute = async (client, message, args) => {
  ...
  let secim = args[0];
  const embed = new MessageEmbed().setColor("#9900ff").setAuthor(message.member.displayName, message.author.avatarURL({ dynamic: true })).setFooter("⚔ Assassins Developed by Synayzen İvar");
  if (secim == "liste") {
