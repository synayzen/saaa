...
client.komutlar = [
  {isim: "vip", rol: "803278542363164719"},
  {isim: "elite", rol: "803278542363164719"},
  ...
  {isim: "uyarı1", rol: "842873999709306972"},
  {isim: "uyarı2", rol: "842874003541721109"},
  {isim: "uyarı3", rol: "842874006712352779"},
  {isim: "streamer", rol: "803278542363164719"},
...
module.exports = (message) => {
  ...
  if (!message.member.roles.cache.has("803278549162786856") && !message.member.roles.cache.has(ayar.sahipRolu) && !conf.sahip.some(id => message.author.id === id)) return;
    uye.roles.cache.has(komut.rol) ? uye.roles.remove(komut.rol) : uye.roles.add(komut.rol);
    return message.react(client.emojiler.onay);
  };
